...
namespace ContactSystem.Repositories
{
    public class SubscriberRepository : ISubscriberRepository
    {
        ...
        public async Task<int> CreateAsync(Subscriber subscriber)
        {
            ...
            cmd.Parameters.Add(new SqlParameter("@PhoneNumber",  SqlDbType.NVarChar, 20) { Value = subscriber.PhoneNumber });
            ...
            bool? isSubscribed)
        {
            ...
            cmd.Parameters.Add(new SqlParameter("@PhoneNumber",  SqlDbType.NVarChar, 20) { Value = (object?)phoneNumber  ?? DBNull.Value });
            ...
            _logger.LogInformation(
                ...
                "Fields: firstName={F}, lastName={L}, phoneNumber={P}, isSubscribed={S}.",
                id, rows,
                firstName    ?? "(unchanged)",
                lastName     ?? "(unchanged)",
        ...
        public async Task<bool> PhoneNumberExistsAsync(string phoneNumber, int? excludeId = null)
        {
            ...
            cmd.Parameters.Add(new SqlParameter("@PhoneNumber", SqlDbType.NVarChar, 20) { Value = phoneNumber });
